...
namespace dll_Natasha
{
    public partial class produkt_form : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            f.produktBindingSource1.DataSource = produktBindingSource;
            f.produktBindingSource2.DataSource = produktBindingSource;

            //чтобы они указывали в таблице на одну и ту же запись
            f.produktBindingSource.Position = produktBindingSource.Position;
            f.produktBindingSource1.Position = produktBindingSource.Position;
            f.produktBindingSource2.Position = produktBindingSource.Position;
